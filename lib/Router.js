  ...
  return React.createClass({
      ...
      render: function() {
        ...
        if (isPopState && this.props.popStateTransitionName) {
          transitionName = this.props.popStateTransitionName;
        } else if (this.state.navigation.transitionName) {
          transitionName = this.state.navigation.transitionName;
        }

        if(transitionName) {
          props.transitionName = transitionName;
        }
        else {
          props.transitionEnter = props.transitionLeave = false;
        }
